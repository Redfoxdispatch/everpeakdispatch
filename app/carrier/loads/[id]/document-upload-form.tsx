...
import { uploadCarrierDocument, type DocumentActionState } from "../../documents/actions";
...
export function DocumentUploadForm({ loadId }: { loadId: string }) {
  const [state, formAction] = useActionState<DocumentActionState, FormData>(uploadCarrierDocument, {});
